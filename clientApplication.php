	...
	else
	{
		...
		while($row = mysqli_fetch_assoc($result))
		{
			...
			else
			{
				...
				{
					$emergencyContactInfo .= '<div class="eci_row"><input placeholder="Contact Name" type="text" id="eci_name">';
					$emergencyContactInfo .= '<input placeholder="Contact Email" style="margin-left:10px;" type="text" id="eci_email">';
					$emergencyContactInfo .= '<input placeholder="Phone Number"style="margin-left:10px;" type="text" id="eci_phone_number"><div onclick="addECIRow();"style="margin-left:5px;display:inline-block;cursor: pointer;"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-plus-fll" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
